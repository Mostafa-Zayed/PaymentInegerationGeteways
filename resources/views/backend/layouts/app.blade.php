...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('backend/vendors/css/charts/chartist-plugin-tooltip.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('backend/vendors/css/forms/toggle/bootstrap-switch.min.css')}}">
...
<!-- BEGIN VENDOR JS-->
<script src="{{asset('backend/vendors/js/tables/datatable/datatables.min.js')}}"
        type="text/javascript"></script>
<script src="{{asset('backend/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"
        type="text/javascript"></script>

<script src="{{asset('backend/vendors/js/forms/toggle/bootstrap-switch.min.js')}}"
        type="text/javascript"></script>
<script src="{{asset('backend/vendors/js/forms/toggle/bootstrap-checkbox.min.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('backend/vendors/js/charts/echarts/echarts.js')}}" type="text/javascript"></script>

<script src="{{asset('backend/vendors/js/extensions/datedropper.min.js')}}" type="text/javascript"></script>
<script src="{{asset('backend/vendors/js/extensions/timedropper.min.js')}}" type="text/javascript"></script>

<script src="{{asset('backend/vendors/js/forms/icheck/icheck.min.js')}}" type="text/javascript"></script>
<script src="{{asset('backend/js/scripts/pages/chat-application.js')}}" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN MODERN JS-->
...
<script src="{{asset('backend/js/scripts/tables/datatables/datatable-basic.js')}}"
        type="text/javascript"></script>
<script src="{{asset('backend/js/scripts/extensions/date-time-dropper.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->

<script src="{{asset('backend/js/scripts/forms/checkbox-radio.js')}}" type="text/javascript"></script>

<script src="{{asset('backend/js/scripts/modal/components-modal.js')}}" type="text/javascript"></script>
